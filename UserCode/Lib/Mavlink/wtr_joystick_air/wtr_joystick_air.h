...
#define MAVLINK_WTR_JOYSTICK_AIR_XML_HASH 113146724405238735
...
#define MAVLINK_MESSAGE_CRCS {{209, 237, 41, 41, 0, 0, 0}, {210, 64, 18, 18, 0, 0, 0}, {211, 39, 21, 21, 0, 0, 0}, {212, 22, 21, 21, 0, 0, 0}, {213, 36, 1, 1, 0, 0, 0}}
#endif
